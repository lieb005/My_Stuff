...
__tmp_reg__ = 0
__zero_reg__ = 1
	.stabs	"/home/mark/workspace_c/usbtiny-1.6/spi/",100,0,2,.Ltext0
...
string_device:
	...
	.stabs	"string_device:G(0,57)=k(0,58)=s24length:(8,1),0,8;type:(8,1),8,8;string:(0,59)=ar(0,52);0;10;(0,1),16,176;;",32,0,103,0
	.text
