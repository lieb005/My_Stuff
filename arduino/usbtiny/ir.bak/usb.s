...
__tmp_reg__ = 0
__zero_reg__ = 1
	.stabs	"/home/mark/workspace_c/usbtiny-1.6/ir/",100,0,2,.Ltext0
...
string_device:
	...
	.stabs	"descr_config:S(0,55)=ar(0,52);0;24;(0,53)",38,0,160,descr_config
	.stabs	"usb_rx_buf:G(0,56)=ar(0,52);0;21;(8,1)",32,0,53,0
	.stabs	"usb_rx_off:G(8,1)",32,0,54,0
	.stabs	"usb_rx_len:G(8,1)",32,0,55,0
	.stabs	"usb_rx_token:G(8,1)",32,0,56,0
	.stabs	"usb_tx_buf:G(0,57)=ar(0,52);0;10;(8,1)",32,0,58,0
	.stabs	"usb_tx_len:G(8,1)",32,0,59,0
	.stabs	"usb_address:G(8,1)",32,0,61,0
	.stabs	"usb_new_address:G(8,1)",32,0,62,0
	.stabs	"string_device:G(0,58)=k(0,59)=s30length:(8,1),0,8;type:(8,1),8,8;string:(0,60)=ar(0,52);0;13;(0,1),16,224;;",32,0,103,0
	.text
