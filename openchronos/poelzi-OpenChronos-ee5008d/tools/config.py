...
DATA["CONFIG_AUTOSYNC"] = {
        ...
        "default": False,
	"help": "Automatically sync clock after reboot",
}
...
DATA["ECO_DISPLAY"] = {
	...
	"depends": [],
	"default": False}
###IMPLEMENTED by Mark Liebscher
DATA["CONFIG_ALWAYS_ECO"] = {
	"name": "Always Economical display.",
	"help": "Lower display frequency and -30% current consumption all the time.",
	"depends": [],
	"default": False}
...
###Implemented By Mark Liebscher
DATA["CONFIG_NOTES"] = {
        "name": "Notes (1404 bytes)",
        "depends": [],
        "default": False,
	"help": "Be able to take down 10, 6-20 letter/number notes."}

DATA["CONFIG_NOTES_PREVIOUS"] = {
        "name": "Previous Notes",
        "depends": [],
        "default": False,
	"help": "Load the info in notes.prev.c to notes when reflashed."}

DATA["CONFIG_SCHEDULE"] = {
        "name": "Schedule (1186 bytes)",
        "depends": [],
        "default": False,
	"help": "Show which period you are in at school. (Pioneer High School)"}

DATA["CONFIG_SCHOOLALARM"] = {
        "name": "School Alarm",
        "depends": [],
        "default": False,
	"help": "Makes the alarm adjust for Pioneer High School's start times and turns it off on the weekends."}

DATA["CONFIG_CALENDAR"] = {
        "name": "Calendar",
        "depends": [],
        "default": False,
        "help": "A calendar to track tasks, upcoming tasks, make reminders, and set alarms.  Can view dates and set agenda on any date. (Doesn't work yet)"}
	
DATA["CONFIG_EGGWATCH"] = {
	"name": "Eggwatch",
	"depends": [],
	"default": True,
	"help": "A combination of the stopwatch and eggtimer (but eggwatch only shows seconds so far, not milliseconds) (Does not Beep!!!!)"}
	
DATA["CONFIG_METRONOME"] = {
	"name": "Metronome",
	"depends": [],
	"default": False,
	"help": "An adjustable duration metronome. (Doesn't work yet)"}

DATA["CONFIG_BACKLIGHT_TOGGLE"] = {
	"name": "Backlight Press",
	"depends": [],
	"default": False,
	"help": "A Toggle Button for Backlight. (Doesn't work yet)"}
	
DATA["CONFIG_PEDOMETER"] = {
	"name": "Pedometer",
	"depends": ["Accelerometer"],
	"default": False,
	"help": "A Pedometer. (Doesn't work yet)"}
