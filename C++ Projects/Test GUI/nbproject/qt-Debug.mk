#############################################################################
# Makefile for building: dist/Debug/GNU-Linux-x86/Test_GUI
...
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++ -Inbproject -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I. -I.
LINK          = g++
...
dist: 
	@test -d build/Debug/GNU-Linux-x86/Test_GUI1.0.0 || mkdir -p build/Debug/GNU-Linux-x86/Test_GUI1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/Test_GUI1.0.0/ && $(COPY_FILE) --parents main.cpp build/Debug/GNU-Linux-x86/Test_GUI1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/Test_GUI1.0.0` && $(TAR) Test_GUI1.0.0.tar Test_GUI1.0.0 && $(COMPRESS) Test_GUI1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/Test_GUI1.0.0`/Test_GUI1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/Test_GUI1.0.0
...
build/Debug/GNU-Linux-x86/main.o: main.cpp /usr/include/qt/QtGui/QtGui \
