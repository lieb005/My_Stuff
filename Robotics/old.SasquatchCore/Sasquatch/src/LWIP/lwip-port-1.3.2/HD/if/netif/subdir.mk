...
C_SRCS += \
../src/LWIP/lwip-port-1.3.2/HD/if/netif/wlif.c 

OBJS += \
./src/LWIP/lwip-port-1.3.2/HD/if/netif/wlif.o 

C_DEPS += \
./src/LWIP/lwip-port-1.3.2/HD/if/netif/wlif.d 


# Each subdirectory must supply rules for building sources it contributes
src/LWIP/lwip-port-1.3.2/HD/if/netif/%.o: ../src/LWIP/lwip-port-1.3.2/HD/if/netif/%.c
	@echo 'Building file: $<'
