...
C_SRCS += \
../src/lwip-port-1.3.2/HD/if/netif/wlif.c 

OBJS += \
./src/lwip-port-1.3.2/HD/if/netif/wlif.o 

C_DEPS += \
./src/lwip-port-1.3.2/HD/if/netif/wlif.d 


# Each subdirectory must supply rules for building sources it contributes
src/lwip-port-1.3.2/HD/if/netif/%.o: ../src/lwip-port-1.3.2/HD/if/netif/%.c
	@echo 'Building file: $<'
