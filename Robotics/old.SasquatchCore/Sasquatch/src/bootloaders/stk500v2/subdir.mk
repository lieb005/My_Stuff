...
C_SRCS += \
../src/bootloaders/stk500v2/stk500boot.c 

OBJS += \
./src/bootloaders/stk500v2/stk500boot.o 

C_DEPS += \
./src/bootloaders/stk500v2/stk500boot.d 


# Each subdirectory must supply rules for building sources it contributes
src/bootloaders/stk500v2/%.o: ../src/bootloaders/stk500v2/%.c
	@echo 'Building file: $<'
