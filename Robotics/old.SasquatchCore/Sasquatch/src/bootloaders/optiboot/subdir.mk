...
C_SRCS += \
../src/bootloaders/optiboot/optiboot.c 

OBJS += \
./src/bootloaders/optiboot/optiboot.o 

C_DEPS += \
./src/bootloaders/optiboot/optiboot.d 


# Each subdirectory must supply rules for building sources it contributes
src/bootloaders/optiboot/%.o: ../src/bootloaders/optiboot/%.c
	@echo 'Building file: $<'
