...
C_SRCS += \
../src/wifiHD/src/SOFTWARE_FRAMEWORK/DRIVERS/GPIO/gpio.c 

OBJS += \
./src/wifiHD/src/SOFTWARE_FRAMEWORK/DRIVERS/GPIO/gpio.o 

C_DEPS += \
./src/wifiHD/src/SOFTWARE_FRAMEWORK/DRIVERS/GPIO/gpio.d 


# Each subdirectory must supply rules for building sources it contributes
src/wifiHD/src/SOFTWARE_FRAMEWORK/DRIVERS/GPIO/%.o: ../src/wifiHD/src/SOFTWARE_FRAMEWORK/DRIVERS/GPIO/%.c
	@echo 'Building file: $<'
