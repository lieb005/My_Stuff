...
C_SRCS += \
../src/wifi_dnld/src/SOFTWARE_FRAMEWORK/BOARDS/ARDUINO/led.c 

OBJS += \
./src/wifi_dnld/src/SOFTWARE_FRAMEWORK/BOARDS/ARDUINO/led.o 

C_DEPS += \
./src/wifi_dnld/src/SOFTWARE_FRAMEWORK/BOARDS/ARDUINO/led.d 


# Each subdirectory must supply rules for building sources it contributes
src/wifi_dnld/src/SOFTWARE_FRAMEWORK/BOARDS/ARDUINO/%.o: ../src/wifi_dnld/src/SOFTWARE_FRAMEWORK/BOARDS/ARDUINO/%.c
	@echo 'Building file: $<'
