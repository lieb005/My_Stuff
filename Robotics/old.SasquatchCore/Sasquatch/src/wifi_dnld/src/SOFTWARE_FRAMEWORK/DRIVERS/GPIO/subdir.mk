...
C_SRCS += \
../src/wifi_dnld/src/SOFTWARE_FRAMEWORK/DRIVERS/GPIO/gpio.c 

OBJS += \
./src/wifi_dnld/src/SOFTWARE_FRAMEWORK/DRIVERS/GPIO/gpio.o 

C_DEPS += \
./src/wifi_dnld/src/SOFTWARE_FRAMEWORK/DRIVERS/GPIO/gpio.d 


# Each subdirectory must supply rules for building sources it contributes
src/wifi_dnld/src/SOFTWARE_FRAMEWORK/DRIVERS/GPIO/%.o: ../src/wifi_dnld/src/SOFTWARE_FRAMEWORK/DRIVERS/GPIO/%.c
	@echo 'Building file: $<'
